...
impl Materials {
        ...
        F: FnMut(Box<Surface + 'a>),
    {
        ...
        let mut pos_y =
            ((row_ior.len() - 1) as Real) * radius + offset_y * (row_ior.len() / 2) as Real;
            ...
            for i in 0..spheres_num {
                ...
                let mat: Arc<Bsdf> = if r == 0 {
                    ...
                    Arc::new(CookTorrance::new(
                        color::BLACK,
                        math::calc3_f0(&air_ior, &row_ior[r]),
                        roughness * roughness,
                    ))
                ...
                let sphere = box Sphere::new(Point3f::new(pos_x, pos_y, 0.0), radius, mat);
        ...
        F: FnMut(Box<Surface + 'a>),
    {
        ...
        let mut normal_tex: Texture<Rgb<f64>> =
            load_texture_rgb64("data/testnormal.png".to_string(), false);
